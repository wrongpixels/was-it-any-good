...
export const SEARCH_CARD_H: string = `h-${SEARCH_CARD_HEIGHT}`;
export const SEARCH_CARD_W: string = `w-${SEARCH_CARD_WIDTH}`;
export const PERSON_ROLE_CARD_W: string = `w-${PERSON_ROLE_CARD_WIDTH}`;
