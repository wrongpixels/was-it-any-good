    ...
    <div {...props}>
      ...
      >
        ...
        >
          <div
            className={
              'flex flex-row pt-1 opacity-100 brightness-95 hover:brightness-105 hover:saturate-75 hover:opacity-100 transition-all'
            }
          >
            <IconWIAGLogoImage className={'drop-shadow-xs/50'} />
            <span className="font-normal italic ml-2 text-xs text-staryellow-bright/95 hidden sm:inline pt-0.5">
              {'Was It Any Good'}
