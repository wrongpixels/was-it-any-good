...
const mediaBubbleClassName: string =
  'text-xs font-medium px-2 pb-0.25 rounded-xl text-starblue overflow-clip border border-starbrighter hover:bg-starbright hover:text-white bg-starbright/25 hover:border-starbright';

const cardBubbleClassName: string =
  'text-xs font-medium px-2 pb-0.25 rounded-xl text-stardark  overflow-clip border border-starbrighter bg-starbright/25';
